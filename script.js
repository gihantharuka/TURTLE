...
function updateTable() {
  ...
  if (slChild > 0) {
    ...
    typeCell.textContent = slChild+" SL Child";
  ...
  if (slAdult > 0) {
    ...
    var typeCell = row.insertCell(0);
    typeCell.textContent = slAdult+ " SL Adult";
    var priceCell = row.insertCell(1);
  ...
  if (fChild > 0) {
    ...
    var typeCell = row.insertCell(0);
    typeCell.textContent = fChild + " Foreign Child"; 
    var priceCell = row.insertCell(1);
  ...
  if (fAdult > 0) {
    ...
    var typeCell = row.insertCell(0);
    typeCell.textContent = fAdult + " Foreign Adult"; 
    var priceCell = row.insertCell(1);
  ...
  if (infant > 0) {
    ...
    var typeCell = row.insertCell(0);
    typeCell.textContent = infant + " Infant"; 
    var priceCell = row.insertCell(1);
...
function timesup() {
  ...
  const timesArrayj = JSON.stringify(timesArray);

  localStorage.setItem("timesArrayl", timesArrayj);
                  
}

//FUNCTION TO SHOW SELECTRED TIME SLOTS ON 2,3,4 TH PAGES        
function timesup2() {

  const timesArrayj = localStorage.getItem("timesArrayl");

  const timesArray = JSON.parse(timesArrayj);
...
function uptablef() {
 ...
 // Run the functions on tickets page
...
// Function to show error message for payment page
...
// Function to show success message payment page
...
//Function to store the form inputs to local storage
...
//Function to check validity of the form in payment page
function form2f() {
